    ...
    <div className="beny_tm_hero" id="home">
      <div className="background">
        <div
          ...
          style={{
            backgroundImage: `url(${
              process.env.PUBLIC_URL + "img/slider/hero-image.png"
            })`,
          }}
        ></div>
      </div>
        ...
        <div className="content">
          <div className="content_inner">
            ...
            <p
              ...
              data-aos-delay="100"
            >
              I'm web developer with 7+ years of marketing and design experience. I am
              passionate about crafting user-friendly web applications that offer robust user experiences.
            </p>
            <div
